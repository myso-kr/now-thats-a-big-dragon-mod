# -*- coding: utf-8 -*-
"""Writes the Latin American Spanish .ink dialogues.

Derived from the Castilian text rather than translated again: "vosotros" and the
peninsular vocabulary give way to Latin American forms. Everything else - the tags,
knots, diverts and interpolations - is unchanged.
"""
...
# pace:35
# wait:400
¡Presiona el botón del arpa y disfruta del subidón temporal!
